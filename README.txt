...
Open up the project file in QT Creator (look for the Taskinator 3000.pro file), then press play!

Taskinator stores all your tasks, schedules, and progress on the local storage of your computer, so it always remembers where you left off!

*** Some details ***

All your daily tasks persist forward in time, but not backwards (why would you want to give yourself something to do yesterday?)
...
Custom CSS styles sourced from online
Not all documentation and error checking was finished, but it's pretty hard to break things from the UI.
